...
class DefaultHarga extends CI_Controller {
	...
	public function saveData(){
		...
		$data=array(
			...
			'k_floatingctn'=>$this->input->post('k_floatingctn'),
			'LastUpdate'=>date('Y-m-d H:i:s'),
			'devided'=>$this->input->post('h_devided'),
			'jasaoven'=>$this->input->post('jasaoven'),
			'sawteeth'=>$this->input->post('sawteeth'),
			'glides'=>$this->input->post('glides'),
			'cornerluar'=>$this->input->post('cornerluar'),
			'babat_250'=>$this->input->post('babat_250'),
			'bautjcbc'=>$this->input->post('bautjcbc'),
			'nanasan'=>$this->input->post('nanasan'),
			'kuncil'=>$this->input->post('kuncil'),
