...
<table class="table">
  <tr>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_ctnboxp" min="0" value="<?= $dd['CartonP'];?>" placeholder="(Panjang)" onchange="setSizeCrt();hitCtnboxCBM();" <?php if($dd['CartonP']!=0&&$dd['CartonL']!=0&&$dd['CartonT']!=0){echo '';}else{echo 'readonly';}?>></td>
    <td class="text-center"><span class="fa fa-times"></span></td>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_ctnboxl" min="0" value="<?= $dd['CartonL'];?>" placeholder="(Lebar)" onchange="setSizeCrt();hitCtnboxCBM();" <?php if($dd['CartonP']!=0&&$dd['CartonL']!=0&&$dd['CartonT']!=0){echo '';}else{echo 'readonly';}?>></td>
    <td class="text-center"><span class="fa fa-times"></span></td>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_ctnboxt" min="0" value="<?= $dd['CartonT'];?>" placeholder="(Tinggi)" onchange="setSizeCrt();hitCtnboxCBM();" <?php if($dd['CartonP']!=0&&$dd['CartonL']!=0&&$dd['CartonT']!=0){echo '';}else{echo 'readonly';}?>></td>
  </tr>
</table>
</div>
<div class="col-md-4">
