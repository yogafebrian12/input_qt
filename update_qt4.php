...
<div class="col-md-8">
  <div class="input-group">
    ...
    <input type="text" class="form-control inputs qtotprice" id="h_jasaoven" value="<?php echo $dd['biayaJasaOven'];?>" min="0" readonly>
  </div>
...
<table class="table">
<tr>
  <td><div class="form-group has-feedback"><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_styrofoam" value="<?= $dd['lbrStyrofoam'];?>" min="0" onkeyup="setSizeCtnbox();setSizeCrt();hitStyrofoam();setStyrofoam();" <?php if($dd['lbrStyrofoam']!=0){echo '';}else{echo 'readonly';}?>><span class="form-control-feedback">LBR</span></div></td>
  <td class="text-center"><span class="fa fa-times"></span></td>
...
<div class="col-md-12">
<div class="checkbox">
<label><b>CARTON BOX PRICE</b></label>
</div>
</div>
<div class="col-md-8">
<table class="table">
...
<div class="col-md-12">
<div class="checkbox">
<label><input type="checkbox" class="checkbox" id="cb_floatingctnbox" <?php if($dd['FloatingCartonP']!=0&&$dd['FloatingCartonL']!=0&&$dd['FloatingCartonT']!=0){echo 'checked';}else{echo '';}?>> <b>FLOATING CARTON BOX SIZE</b></label>
</div>
</div>
<div class="col-md-8">
<table class="table">
  <tr>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_floatingctnboxp" min="0" value="<?= $dd['FloatingCartonP'];?>" placeholder="(Panjang)" onchange="setSizeCrt();hitCtnboxCBM();" <?php if($dd['FloatingCartonP']!=0&&$dd['FloatingCartonL']!=0&&$dd['FloatingCartonT']!=0){echo '';}else{echo 'readonly';}?>></td>
    <td class="text-center"><span class="fa fa-times"></span></td>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_floatingctnboxl" min="0" value="<?= $dd['FloatingCartonL'];?>" placeholder="(Lebar)" onchange="setSizeCrt();hitCtnboxCBM();" <?php if($dd['FloatingCartonP']!=0&&$dd['FloatingCartonL']!=0&&$dd['FloatingCartonT']!=0){echo '';}else{echo 'readonly';}?>></td>
    <td class="text-center"><span class="fa fa-times"></span></td>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_floatingctnboxt" min="0" value="<?= $dd['FloatingCartonT'];?>" placeholder="(Tinggi)" onchange="setSizeCrt();hitCtnboxCBM();" <?php if($dd['FloatingCartonP']!=0&&$dd['FloatingCartonL']!=0&&$dd['FloatingCartonT']!=0){echo '';}else{echo 'readonly';}?>></td>
  </tr>
</table>
</div>
<div class="col-md-4">
...
<div class="col-md-12">
<div class="checkbox">
<label><b>FLOATING CARTON BOX PRICE</b></label>
</div>
</div>
<div class="col-md-8">
<table class="table">
...
<table class="table">
<tr>
  <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_crtcbm1" value="<?= $dd['JmlPapan'];?>" min="0" onkeyup="hitHargaCrt();" <?php if($dd['CrateP']!=0&&$dd['CrateL']!=0&&$dd['CrateT']!=0&&$dd['JmlPapan']!=0){echo '';}else{echo 'readonly';}?>></td>
  <td class="text-center"><span class="fa fa-times"></span></td>
...
<table class="table">
  ...
  <td class="text-center"><span class="fa fa-times"></span></td>
  <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_truckingcostcbm" value="<?= $dd['CBMItemTru'];?>" min="0" onkeyup="hitTrucking();"></td>
</table>
</div>
<div class="col-md-4">
<table class="table">
...
<table class="table">
  <tr>
    ...
    <td class="text-center"><span class="fa fa-times"></span></td>
    <td><input type="text" pattern="[0-9]*" class="form-control inputs decimal" id="pk_containercostcbm" value="<?= $dd['CBMItemCon'];?>" min="0" onkeyup="hitContainer();"></td>
  </tr>
</table>
</div>
<div class="col-md-4">
...
<div class="text-center">
  ...
  <button class="btn btn-warning inputs" onclick="preinputbaru();">Buat baru</button>
</div>
</div>
</div>
</div>
...
function subTotal2(){
  var res=(parseFloat($('#pk_brownpapertotal').val())+parseFloat($('#pk_fstotal').val())+parseFloat($('#pk_bstotal').val())+parseFloat($('#pk_shreddedpapertotal').val())+parseFloat($('#pk_singlefacetotal').val())+parseFloat($('#pk_plastiktotal').val())+parseFloat($('#pk_mftotal').val())+parseFloat($('#pk_innerboxprice').val().replace('.',''))+parseFloat($('#pk_styrofoamtotal').val())+parseFloat($('#pk_cornertotal').val())+parseFloat($('#pk_ctnboxtotal').val())+parseFloat($('#pk_floatingctnboxtotal').val())+parseFloat($('#pk_crttotal').val())+parseFloat($('#pk_manpowerprice').val().replace('.',''))+parseFloat($('#pk_truckingtotal').val())+parseFloat($('#pk_containercosttotal').val())+parseFloat($('#pk_ispntotal').val())+parseFloat($('#pk_jhooktotal').val())+parseFloat($('#pk_dringtotal').val())+parseFloat($('#pk_ringhangertotal').val())+parseFloat($('#pk_keyholetotal').val())+parseFloat($('#pk_babattotal').val())+parseFloat($('#pk_babattotal25').val())+parseFloat($('#pk_babattotal5').val())+parseFloat($('#pk_sponatitotal').val())+parseFloat($('#pk_kuncipastotal').val())+parseFloat($('#pk_fishertotal').val())+parseFloat($('#pk_screwtotal').val())+parseFloat($('#pk_glidestotal').val()));
...
function setTrucking(){
  ...
  $('#pk_truckingcostcbm').val(cbm.toFixed(4));
  hitTrucking();
}
...
function hitHargaFloatingCtnbox(){
  ...
  var res=cbm.toFixed(4)*price;
  $('#pk_floatingctnboxtotal').val(res.toFixed(2));
  subTotal2();
  setContainer();
}
...
function hitGlides(){
  ...
  var res = g*gh;
  $('#pk_glidestotal').val(res.toFixed(2));
  subTotal2();
}
