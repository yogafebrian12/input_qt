	...
	<div class="col-lg-12">
		...
		<div class="col-xs-6">
			...
			<div class="col-lg-12">
				<!--<div class="col-xs-6">-->
				<?php if($prt->Foto!=''):?>
				<img class="img-thumbnail" src="<?php echo base_url();?>assets/photo_items/<?php echo $prt->Foto;?>" style="width:250px;height:150px;" />
				<?php else:?>
				<img class="img-thumbnail" src="<?php echo base_url();?>assets/photo_items/null.png" style="width:300px;height:200px;" />
				<?php endif;?>
				<!--</div>-->
			</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-xs-8">
						<p class="small"><?php echo $prt->DimP;?> <i class="fa fa-times"></i> <?php echo $prt->DimL;?> <i class="fa fa-times"></i> <?php echo $prt->DimT;?> CM = <?= $prt->CBMDim;?> CBM</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-xs-8">
						<p class="small"><?php echo $prt->DimP_M;?> <i class="fa fa-times"></i> <?php echo $prt->DimL_M;?> <i class="fa fa-times"></i> <?php echo $prt->DimT_M;?> CM = <?= $prt->CBMDim_M;?> CBM</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="col-xs-8">
						<p class="small"><?php echo $prt->DimP_S;?> <i class="fa fa-times"></i> <?php echo $prt->DimL_S;?> <i class="fa fa-times"></i> <?php echo $prt->DimT_S;?> CM = <?= $prt->CBMDim_S;?> CBM</p>
					</div>
				</div>
			</div>
		...
		<div class="col-xs-6">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="col-xs-6">
						<label class="text-uppercase small">Jasa Oven</label>
					</div>
					<div class="col-xs-6">
						<p class="small"><b>RP</b>&nbsp;&nbsp;<?php echo number_format($prt->biayaJasaOven,2,',','.');?></p>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-12">
			...
			<div class="col-xs-6">
				...
				<div class="col-lg-12">
					...
					<div class="col-xs-3">
						<p class="small">=&nbsp;RP&nbsp;<?php echo number_format($prt->BiayaCrate,2,',','.');?></p>
					</div>
				</div>
				</div>
			...
			<div class="col-xs-6">
				...
				<div class="col-lg-12">
					<div class="col-xs-12">
						<label class="text-uppercase small">Created by =&nbsp;<?= strtoupper($prt->UserInput).' ('.date('d/m/Y',strtotime($prt->WaktuInput)).')';?></label>
					</div>
				</div>
				</div>

				<?php if($prt->UserUpdate!='-'):?>
				<div class="row">
				<div class="col-lg-12">
					<div class="col-xs-12">
						<label class="text-uppercase small">Updated by =&nbsp;<?= strtoupper($prt->UserUpdate).' ('.date('d/m/Y',strtotime($prt->WaktuInput)).')';?></label>
					</div>
				</div>
				</div>
				<?php endif;?>
