...
<table class="table">
  ...
  <td class="text-center"><span class="fa fa-times"></span></td>
  <td><input type="number" class="form-control inputs" id="pk_truckingcostcbm" value="<?= $dd['CBMItemTru'];?>" min="0" onkeyup="hitTrucking();"></td>
</table>
</div>
<div class="col-md-4">
<table class="table">
...
<table class="table">
  <tr>
    ...
    <td class="text-center"><span class="fa fa-times"></span></td>
    <td><input type="number" class="form-control inputs" id="pk_containercostcbm" value="<?= $dd['CBMItemCon'];?>" min="0"  onkeyup="hitContainer();"></td>
  </tr>
</table>
</div>
<div class="col-md-4">
...
function setCrtP(){
  ...
  var c=1;
  if($('#cb_ctnbox').prop('checked')){
  res=parseFloat($('#pk_ctnboxp').val())+(k_crt);
  }else{
  $('.item-dim-p').each(function(){
    var v=$(this).val();
    if(v!=0){
...
function setCrtL(){
  ...
  var c=1;
  if($('#cb_ctnbox').prop('checked')){
  res=parseFloat($('#pk_ctnboxl').val())+(k_crt);
  }else{
  res=l+(k_crt);
  /*$('.item-dim-l').each(function(){
    var v=$(this).val();
...
function setCrtT(){
  ...
  var res=0;
  if($('#cb_ctnbox').prop('checked')){
  res=parseFloat($('#pk_ctnboxt').val())+(k_crt);
  }else{
  res=l+(k_crt);
  }
