...
<div style="width:100%;">
<table class="tbl-detil" style="/*width:820px;*/width: 100vh;">
<tr>
...
<table class="tbl-detil" style="/*width:820px*/width: 100vh;font-size: 12px;">
	<tr>
	...
	<tr>
		...
		<td class="text-right"><label class="text-uppercase">Over Head (<?= number_format($q['OverHeadPersen'],0);?> %)</label></td>
...
<div class="text-center">
	<button class="btn btn-warning" onclick="preupdate(<?php echo $q['id'];?>);"><i class="fa fa-edit"></i> Update</button>
	<a class="btn btn-primary" href="<?php echo site_url('printQt').'/'.$q['id'];?>" target="__blank"><i class="fa fa-print"></i> Print</a>
	<?php if($this->session->userdata('level')=='1'):?>
	<button class="btn btn-danger" onclick="preDelData(<?php echo $q['id'];?>);"><i class="fa fa-trash"></i> Hapus</button>
	<?php endif;?>
</div>
</div>
