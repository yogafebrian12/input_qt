...
<div class="col-md-4">
	...
	<div class="form-group">
		<label>Glides / PCS</label>
		<div class="input-group">
		<span class="input-group-addon">RP</span>
		<input type="text" class="form-control inputs qprice" name="glides" value="<?= $d['glides'];?>">
		</div>
	</div>

	<div class="form-group">
		<label>Absorb Dry (250 GR) / PCS</label>
		<div class="input-group">
		<span class="input-group-addon">RP</span>
		<input type="text" class="form-control inputs qprice" name="babat_250" value="<?= $d['babat_250'];?>">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="input-group">
			<span class="input-group-addon">RP</span>
			<input type="text" class="form-control qprice" name="kuncil" value="<?= $d['kuncil'];?>">
		</div>
	</div>
...
<div class="col-md-4">
	...
	<div class="form-group">
		...
		<div class="input-group">
			<span class="input-group-addon">RP</span>
			<input type="text" class="form-control qprice" name="devided" value="<?= $d['devided'];?>">
		</div>
		<small id="kurs_bca_now" class="text-info"></small>
	</div>

	<div class="form-group">
		<label>Corner Luar</label>
		<div class="input-group">
			<span class="input-group-addon">RP</span>
			<input type="text" class="form-control qprice" name="cornerluar" value="<?= $d['cornerluar'];?>">
		</div>
	</div>

	<div class="form-group">
		<label>Baut JCBC</label>
		<div class="input-group">
			<span class="input-group-addon">RP</span>
			<input type="text" class="form-control qprice" name="bautjcbc" value="<?= $d['bautjcbc'];?>">
		</div>
	</div>
...
<div class="col-md-4">
	...
	<div class="form-group">
		<label>Jasa Oven</label>
		<div class="input-group">
			<span class="input-group-addon">RP</span>
			<input type="text" class="form-control inputs qprice" name="jasaoven" value="<?= $d['jasaoven'];?>">
		</div>
	</div>

	<div class="form-group">
		<label>Sawteeth / PCS</label>
		<div class="input-group">
		<span class="input-group-addon">RP</span>
		<input type="text" class="form-control inputs qprice" name="sawteeth" value="<?= $d['sawteeth'];?>">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="input-group">
			<span class="input-group-addon">RP</span>
			<input type="text" class="form-control qprice" name="nanasan" value="<?= $d['nanasan'];?>">
		</div>
	</div>
...
<div class="col-md-12">
	<div class="col-md-3">
		<div class="form-group">
			<label class="text-uppercase">Margin (%)</label>
			<div class="input-group">
				<input type="number" class="form-control" name="margin" value="<?php echo $d['Margin'];?>" required>
				<span class="input-group-addon">%</span>
			</div>
		</div>
	</div>
...
<div class="form-group">
	...
	<div class="input-group">
		<input type="number" class="form-control inputs" name="k_mf" value="<?= $d['k_mf'];?>" min="0">
	</div>
</div>
...
<div class="form-group">
	<label>Carton Box</label>
	<div class="input-group">
		<input type="number" class="form-control inputs" name="k_ctn" value="<?= $d['k_ctn'];?>" min="0">
	</div>
</div>
...
<div class="form-group">
	<label>Crate</label>
	<div class="input-group">
		<input type="number" class="form-control inputs" name="k_crt" value="<?= $d['k_crt'];?>" min="0">
	</div>
</div>
...
<div class="form-group">
	...
	<input type="number" class="form-control inputs" name="k_sr" value="<?= $d['k_sr'];?>" min="0">
</div>
...
<div class="form-group">
	<label>Corner</label>
	<input type="number" class="form-control inputs" name="k_floatingctn" value="<?= $d['k_floatingctn'];?>" min="0">
</div>
...
<div class="box-body">
	<div class="row">
		...
		<div class="text-center">
			...
			<button class="btn btn-primary btn-md inputs" onclick="presave();"><span id="btnsave_icon"></span> Simpan</button>
		</div>
		</div>
	</div>
</div>
...
function getKursBca(){
    //var d={matauang:mu};
    $.ajax({
    url:'<?php echo base_url();?>DefaultHarga/kurs',
    type:'POST',
    //data:d,
    dataType:'JSON',
    success:function(result){
        console.log(result);
      var kbeli=parseFloat(result.Beli);
      var kjual=parseFloat(result.Jual);
      $('#kurs_bca').val((kbeli+kjual)/2);
      $('#kurs_bca_now,#kurs_bca_now1,#kurs_bca_now2,#kurs_bca_now3,#kurs_bca_now4,#kurs_bca_now5').html('(BCA) Kurs Beli: RP '+kbeli+', Kurs Jual: RP '+kjual+', Kurs Tengah: RP '+(kbeli+kjual)/2);
      console.log((kbeli+kjual)/2);
    }/*,error:function(xhr){
...
function saveData(){
	var d={
		...
		k_floatingctn:$('input[name="k_floatingctn"]').val(),
		h_devided:$('input[name="devided"]').val(),
		jasaoven:$('input[name="jasaoven"]').val(),
		glides:$('input[name="glides"]').val(),
		cornerluar:$('input[name="cornerluar"]').val(),
		sawteeth:$('input[name="sawteeth"]').val(),
		babat_250:$('input[name="babat_250"]').val(),
		bautjcbc:$('input[name="bautjcbc"]').val(),
		nanasan:$('input[name="nanasan"]').val(),
		kuncil:$('input[name="kuncil"]').val(),
