...
<div class="col-xs-6">
<table class="table table-bordered" style="font-size: 8px;padding:5px;">
	<tr>
	...
	<tr>
		<td class="text-right"><label>CODE</label></td>
		<td>= <?= $q['Kode'];?></td>
	</tr>
	<tr>
...
<table class="table table-bordered" style="font-size: 8px;">
	<tr>
		<td class="text-right"><label>SP PRICE</label></td>
...
<table class="table table-bordered" style="font-size: 7px;">
	<tr>
